    ...
    <div id="wrapper">
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                    <div><img src="assets/img/icon_bw.png"></div>
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    <li class="nav-item"><a class="nav-link" href="table.html" style="background: rgba(252,252,252,0.09);"><i class="fas fa-database" style="width: 18px;"></i><span>Update JOT</span></a></li>
                    <li class="nav-item"><a class="nav-link" href="table-1.html"><i class="fas fa-database" style="width: 18px;"></i><span>Realisasi JOT</span></a></li>
                    <li class="nav-item"><a class="nav-link" href="form.html"><i class="fas fa-edit" style="width: 18px;"></i><span>Master Cost</span></a></li>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
                    ...
                    <div class="container-fluid"><button class="btn btn-link d-md-none rounded-circle mr-3" id="sidebarToggleTop" type="button"><i class="fas fa-bars"></i></button>
                        <ul class="navbar-nav flex-nowrap ml-auto">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link" aria-expanded="false" data-toggle="dropdown" href="#"><span class="d-none d-lg-inline mr-2 text-gray-600 small">@username</span><i class="fas fa-user" style="color: rgb(95,95,95);"></i></a>
            ...
            <footer class="bg-white sticky-footer">
                <div class="container my-auto">
                    <div class="text-center my-auto copyright"><span>Copyright © IT Cikarang Dry Port 2023</span></div>
                </div>
            </footer>
